...
WidgetPanel {
    ...
    ListView {
        ...
        delegate: Rectangle {
            ...
            height: 64
            radius: 14
            color: active ? Colorscheme.primary_container : theme.glass_card_hover
    ...
    ListView {
        ...
        delegate: Rectangle {
            ...
            height: 64
            radius: 14
            color: active ? Colorscheme.secondary_container : theme.glass_card_hover
            border.width: active ? 0 : 1
            border.color: theme.glass_outline_soft
    ...
    Process {
        ...
        stdout: SplitParser {
            ...
            onRead: (line) => {
                ...
                if (text.startsWith("├─ Sinks:") || text.startsWith("└─ Sinks:")) {
                    deviceScan.section = "sinks";
                    return ;
                }
                if (text.startsWith("├─ Sources:") || text.startsWith("└─ Sources:")) {
                    deviceScan.section = "sources";
                    return ;
                }
                ...
                if (deviceScan.section !== "sinks" && deviceScan.section !== "sources")
                    return ;
    ...
    headerTools: Text {
        ...
        MouseArea {
            anchors.fill: parent
            cursorShape: Qt.PointingHandCursor
            onClicked: Quickshell.execDetached(["desk-app-run", "--", "pavucontrol"])
        }
