...
WidgetPanel {
    ...
    Rectangle {
        ...
        radius: 16
        color: summaryTheme.glass_card_subtle
        border.width: 1
        border.color: summaryTheme.glass_outline_soft
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Text {
                    text: root.wifiEnabled ? (root.currentWifiSsid !== "" ? root.currentWifiSsid : "Wi-Fi 已开启") : "Wi-Fi 已关闭"
                    font.bold: true
                    font.pixelSize: 14
                ...
                Text {
                    text: root.wifiEnabled ? (root.currentWifiSsid !== "" ? ("已连接 · 信号 " + root.currentWifiSignal + "%") : "正在等待可用网络") : "打开后可扫描并连接附近网络"
                    font.pixelSize: 12
                ...
                Text {
                    text: root.ethernetState === "connected" ? ("有线网络在线" + (root.ethernetConnection !== "" ? " · " + root.ethernetConnection : "")) : (root.ethernetDevice !== "" ? "有线网卡已检测" : "未检测到有线网络")
                    font.pixelSize: 11
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: root.currentTab = "ethernet"
                }
    ...
    Rectangle {
        ...
        radius: 17
        color: root.statusError ? Qt.rgba(tabTheme.error.r, tabTheme.error.g, tabTheme.error.b, 0.16) : Qt.rgba(tabTheme.primary.r, tabTheme.primary.g, tabTheme.primary.b, 0.14)
        border.width: 1
        border.color: root.statusError ? Qt.rgba(tabTheme.error.r, tabTheme.error.g, tabTheme.error.b, 0.24) : Qt.rgba(tabTheme.primary.r, tabTheme.primary.g, tabTheme.primary.b, 0.22)
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    radius: 16
                    color: ethTheme.glass_card_subtle
                    border.width: 1
                    border.color: ethTheme.glass_outline_soft
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            radius: 22
                            color: root.ethernetState === "connected" ? ethTheme.primary : Colorscheme.surface_container_highest
                            ...
                            Text {
                                ...
                                font.family: root.mdFont
                                font.pixelSize: 22
                                color: root.ethernetState === "connected" ? Colorscheme.on_primary : ethTheme.text
                            }
                        ...
                        ColumnLayout {
                            ...
                            Text {
                                text: root.ethernetState === "connected" ? "已连接" + (root.ethernetConnection !== "" ? " · " + root.ethernetConnection : "") : (root.ethernetState === "unavailable" ? "网线未接入" : "当前未连接")
                                font.pixelSize: 12
                ...
                Rectangle {
                    ...
                    Layout.preferredHeight: 40
                    radius: 20
                    color: ethTheme.glass_card_hover
    ...
    Process {
        ...
        onExited: (exitCode, exitStatus) => {
            root.showStatus(exitCode === 0 ? ("已连接到 " + targetSsid) : ("连接失败: " + targetSsid), exitCode !== 0);
            scanWifi.running = true;
        }
    }
    ...
    Process {
        ...
        onExited: (exitCode, exitStatus) => {
            root.showStatus(exitCode === 0 ? ("已断开 " + targetSsid) : ("断开失败: " + targetSsid), exitCode !== 0);
            scanWifi.running = true;
        }
    }
