...
Item {
    ...
    Item {
        ...
        RowLayout {
            ...
            // 固定按钮：固定后，鼠标离开通知面板也不会自动关闭。
            Rectangle {
                width: 32
                height: 32
                radius: 16
                color: WidgetState.notifPinned ? Qt.alpha(Colorscheme.primary_container, 0.78) : (pinHover.containsMouse ? theme.glass_card_hover : "transparent")
                border.width: WidgetState.notifPinned ? 1 : 0
                border.color: Qt.alpha(Colorscheme.primary, 0.34)
                ...
                Text {
                    ...
                    font.pixelSize: 14
                    color: WidgetState.notifPinned ? Colorscheme.on_primary_container : theme.text
                    rotation: WidgetState.notifPinned ? 0 : -35
                ...
                MouseArea {
                    ...
                    onClicked: WidgetState.notifPinned = !WidgetState.notifPinned
                }
            ...
            Rectangle {
                ...
                Text {
                    ...
                    opacity: root.hasMessages ? 1 : 0.4
                }
            ...
            Rectangle {
                ...
                height: 32
                radius: 16
                color: modeHover.containsMouse ? theme.glass_card_hover : "transparent"
                ...
                MouseArea {
                    ...
                    cursorShape: Qt.PointingHandCursor
                    onClicked: {
                        WidgetState.notifDisplayMode = WidgetState.notifDisplayMode === "compact" ? "all" : "compact";
                    }
                }
            ...
            Rectangle {
                ...
                height: 32
                radius: 16
                color: closeHover.containsMouse ? theme.glass_card_hover : "transparent"
    ...
    StackLayout {
        ...
        currentIndex: {
            if (WidgetState.notifCurrentView === "detail")
                return 1;

            if (WidgetState.notifDisplayMode === "all")
                return 2;
